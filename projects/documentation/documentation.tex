...
\begin{document}
    ...
    \renewcommand{\mytitle}{Wissenschaftliches Arbeiten mit LaTeX\\Dokumentation}%Titel für oben links
    \renewcommand{\myauthor}{Dr. Frank N. Further}%Name für unten links
...
Bevor wir groß auf irgendwelche Details eingehen, möchte ich erstmal darstellen, wie das Arbeiten mit diesem Tool überhaupt aussieht. Als aller erstes lade dir den Inhalt dieses Github-Repos runter. Dann gehe in den heruntergeladenen Ordner\footnote{Kopiere ihn ggf. noch irgendwo anders hin} und starte die WA\_ LaTeX.exe(Doppelklick).
\section{Schritt 1: Weboberfläche aufrufen}
Nachdem du das Programm gestartet hast, öffne deinen Browser und öffne folgende Adresse: \textbf{http://localhost:8081/overview}. Du solltest dann dieses Bild sehen:
\FloatBarrier
\begin{figure}[!ht]
...
Mithilfe des eben vergebenen Keys kann ich die Quelle nun zitieren\citebib{meinEintrag}{S.235}{Vgl. }:
\begin{verbatim}
